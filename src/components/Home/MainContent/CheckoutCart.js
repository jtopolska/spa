...
const CheckoutCart = (props) => {
    ...
    return (<>
            <TableRow>
              <TableCell component="th" scope="row" className={ cls.cellColor } sx={{ display: 'flex', alignItems: 'center', fontFamily: `'Cormorant Garamond', serif`, fontSize: '20px', color: 'white', pb: '16.5px' }}>
                <img src={ `./images/${image}.jpg` } alt='Spa order' />
                { title }
              </TableCell>
              <TableCell align="right" className={ cls.cellColor } sx={{ fontFamily: `'Cormorant Garamond', serif`, fontSize: '20px', color: '#b9b4b0', pr: '20px' }}>${ price }</TableCell>
              <TableCell align="right" className={ cls.cellColor } >
